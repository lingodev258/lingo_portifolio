...
const hero = () => {
  return (
    <nav className="flex justify-center items-center">
      <div className="w-[800px] h-16 bg-white/5 rounded-[10px] outline outline-[1.50px] outline-blue-400 backdrop-blur-[250px] mt-6 flex justify-between  px-5">
        ...
        <ul className="inline-flex justify-start items-center gap-12">
          {Links.map((item) => (
            <li key={item.label}>
             ...
             hover:outline hover:outline-1 hover:outline-offset-[-1px] hover:outline-sky-800
